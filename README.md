...
|[/v1/coin_news](#获取币种咨询)|获取币种资讯|
|[/v1/notice](#获取最新公告)|获取最新公告|
|[/v1/message](#获取最新快讯)|获取最新快讯|
|[/v1/news](#获取最新咨询)|获取最新咨询|
...
|base|string|对应现实的货币|
|platform|string|选择不同的交易市场|
|type|string|时间段,1h:小时 1d:天 1w:周|
|since|string|从这个时间戳之后的  单位:秒|
|size|string|返回数量 最大1000|
...
```shell
$ curl -XGET http://api.bizhihui.info/v1/changepair?platform=binance
```
